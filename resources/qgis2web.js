...
map.getView().fit([-1119849.693697, 654393.865626, -1114329.843123, 657625.266661], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Buchanan Cluster Map</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_BuchananCommunity_1,
    colName: 'Communityy Name',
    zoom: 10,
    collapsed: true,
    map: map
});
